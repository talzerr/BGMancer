...
export function YouTubeLogo({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
...
export function Spinner({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
...
export function MusicNote({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function MusicNoteOutline({ className = "w-5 h-5" }: IconProps) {
  return (
...
export function ErrorCircle({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
      <path
        fillRule="evenodd"
...
export function PrevTrackIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function NextTrackIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function VolumeHigh({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function VolumeMuted({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
export function ChevronLeftIcon({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function GoogleLogo({ className = "h-4 w-4" }: IconProps) {
  return (
